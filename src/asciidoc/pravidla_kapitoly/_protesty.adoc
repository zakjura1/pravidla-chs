...
.. v případě kola lezeného za dodržení <<#podminky-izolace,podmínek izolace>> <<#boulder-klasicky-format,klasickým formátem>> do konce následující časového limitu pro výměnu závodníků.
