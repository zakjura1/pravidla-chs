...
.. závodníci, kteří nebyli schopni zahájit oba své kvalifikační pokusy nebudou v kole hodnoceni a jejich výsledek bude označen jako DNS
.. závodníci s předčasným startem v prvním nebo druhém pokusu budou hodnoceni na stejné pozici, a to poslední v daném kole
.. podléhající bodům a., b.: závodníci, jejichž pokus nebo oba pokusy byly hodnoceny jako neúspěšné, budou hodnoceni na stejné pozici, a to před závodníky s předčasným startem
.. podléhající bodům a., b., c.: závodníci s alespoň jedním platným časem budou seřazeni sestupně, přičemž závodník s rychlejším časem je umístěn lépe
