...
[[tranzitni-zona]]Tranzitní zóna/Přechodná izolace:: je konkrétní část v rámci <<#soutezni-prostor, Soutěžního prostoru>>, která je upravena tak, aby umožňovala soutěžícícm se připravit (nebo si odpočinout) před na jejich pokus(y) na boudleru/cestě.
