...
. Hlavní rozhodčí musí ověřit, že je na místě vhodně kvalifikovaný zdravotnický personál, aby bylo možné zajistit rychlou pomoc v případě jakékoliv úrazu nebo zranění soutěžícího či pořadatele na závodišti.
+
...
. [[registrace-a-izolace-4]]Kouření v prostoru izolace je zakázáno. Pořadatel však může vyhradit prostor pro kuřáky tak, aby nedošlo porušení podmínek izolace a nebyli omezování ostatní soutěžící.
...
.. mohou používat podle svého uvážení pytlík s magnéziem (suchým nebo tekutým) pouze na své ruce. Nesmí být použité další činidla pro zvýšení přilnavosti (např. pryskyřice)
