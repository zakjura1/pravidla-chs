...
:toc: left
:toclevels: 2
= Výjimky ze soutěžních pravidel ČHS pro Nejvyšší soutěže a 1. ligu mládeže do 14 let ve sportovním lezení pro rok 2022
...
== Obecně
Pro Mistrovství republiky a závody 1. ligy v kategoriích do 14 let platí <<provadeci_predpisy_mladez_1_liga.adoc#,„Prováděcí předpisy ČHS pro závody nejvyšších soutěží a 1. ligy mládeže ve sportovním lezení pro rok 2022“>> a <<pravidla_sl.adoc#,„Pravidla sportovního lezení ČHS 2022“>> s výjimkami v těchto bodech:
...
== Obtížnost
=== Povolené formáty
Máme někde ošetřeno pravidlo pro MČR, že může být v jednom dni?
...
. Pro závody mládeže v kategoriích do 14 let neplatí ustanovení <<pravidla_sl.adoc#pl-kv-flash-boulder-5,5.4.5>> a <<pravidla_sl.adoc#pl-kv-flash-boulder-7,5.4.7>> <<pravidla_sl.adoc#,Pravidel sportovního lezení 2022>>, která zde mají pouze doporučující charakter.
