...
[[pouzitelne-standardy]]Poplatek za protest:: představuje částku definovanou ČHS v souvislosti s podáním protestu v soutěži ohledně dodržování těchto pravidel
...
[[umela-pomoc]]Umělá pomoc:: představuje držení nebo použití čehokoliv z následujícího:
 ...
 .. jakákoliv část <<#lezecky-povrch,lezeckého povrchu>> ohraničené pomocí nepřerušované černé pásky
...
[[soutez]]Soutěž v kalendáři:: je Soutěž, která
...
[[lezecky-povrch]]Lezecký povrch:: představuje použitelnou plochu lezecké stěny:
 ...
 .. vylučující jakýkoliv <<#umely-chyt, Umělý chyt>>, strukturu nebo jiný dočasnou <<#stuktura,Strukturu>> uchycenou na použitelnou plochu
...
[[soutezni-prostor]]Soutěžní prostor:: představuje takovou část v místě konání akce, která je vyhrazená pro sportovní soutěže včetně:
 ..jakékoliv <<#izolacni-zona,Izolační zóny>> nebo <<#zahrivaci-zona,Zahřivací zóny>>
 .. jakékoliv <<#svolavaci-zona,Svolávací zóny>>/<<#tranzitni-zona,Transitní zóny>>
 .. jakékoliv <<#soutezni-zona,Soutěžní zóny>> zahrnující:
...
[[dns]]Neodstartoval nebo DNS:: znamená:
+
--
...
.. násilné, výhružné nebo xxx chování vůči jiné osobě

[[poradatel]Pořadatel]:: představuje osobu zodpovědnou za organizaci a přípravu jakékoliv <<#soutez,Soutěži v kalendáři>>

[[chs-official]]Oficiální činitel ČHS:: znamená jakéhokoliv a každého z činovníků vyjmenovaných v bodě <<#oficialni-soutezni-cinitele>>, který je jmenován pro danou <<#soutez,Soutěž v kalendáři>>.
...
.. doprovázející <<#cleny-tymu,Členy týmu>>
...
[[oficialni-vysledky]]Oficiální výsledky:: jsou výsledky zveřejněné na konci soutěže nebo jakéhokoliv kola soutěže na oficiální nástěnce a jsou podepsané příslušným <<#chs-official,Oficiálním činitelem ČHS>>
...
[[prubezne-vysledky]]Průběžné výsledky/Neoficiální výsledky:: jsou výsledky, které jsou publikovány nebo kolují dříve než je <<#chs-oficial,Oficiální čínovník ČHS>> pro daný závod nebo jakoukoliv cestu či kolo během závodu publikuje

[[jistici-bod]]Jistící bod:: je složen z
.. [[jb1,{counter:jb:a}.]]rychlospojka, spojená se šroubem fixovaným do nosné konstrukce <<#lezecky-povrch,Lezeckého povrchu>> 
.. [[jb2,{counter:jb}.]]karabiny do které závodník zapíná lano. Orientace karabiny musí minimalizovat možnost přetočení karabiny
.. jednoduchou strojově sešitou smyčku příslušné délky spojující <<#jb1>> a <<#jb2>>
...
[[reakcni-cas]]Reakční čas:: je rozdíl mezi časem, kdy soutěžící opustil startovní desku a začátkem startovního signálu. Měří se minimálně na 1/100s a může být 0, kladný nebo záporný
...
[[tranzit-zona]]Tranzitní zóna/Přechodná izolace:: je konkrétní část v rámci <<#soutezni-prostor, Soutěžního prostoru>>, která je upravena tak, aby umožňovala soutěžícícm se připravit (nebo si odpočinout) před na jejich pokus(y) na boudleru/cestě.
...
[[zahrivaci-zona]]Zahřívací zóna:: znamená jakoukoliv část <<#soutezni-prostor,Soutěžního prostoru>> která je určená a vybavená pro potřeby přípravy závodníků
