...
. Závodníci budou do kvalifikačních skupin rozděleni podle průběžného rankingu, následujícím způsobem:
+
...
.. byl úspěšný
.. soutěžící spadnul, nebo se dotknul země po odstartování
...
.. dotkl se oběma rukama TOPu, nebo
..  postavil se na vrchol boulderu.

. Start závodníka bude posouzen jako:
.. správný, když závodník docílil stabilní kontrolované pozice oběma rukama a oběma nohama na startovních chytech bez kontrolování nebo použití jakývkoliv jiných umělých chytů nebo struktur. Aby se předešlo pochybnostem, závodník během startování může
