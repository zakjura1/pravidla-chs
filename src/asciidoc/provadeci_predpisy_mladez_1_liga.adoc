...
:toc: left
:toclevels: 2
= Prováděcí předpisy ČHS pro závody nejvyšších soutěží a 1. ligy v soutěžním lezení dětí a mládeže pro rok 2021
...
Pro všechny typy závodů platí <<pravidla_sl.adoc#,Pravidla soutěžního lezení ČHS 2021>>.

Výjimky ze soutěžních pravidel pro závody kategorií U14 jsou uvedeny v samostatném dokumentu <<vyjimky_pravidla_pro_u14_mcr_1_liga.adoc#,„Výjimky ze soutěžních pravidel ČHS pro Nejvyšší soutěže a 1. ligu mládeže do 14 let v soutěžním lezení pro rok 2021“>>, který je přílohou Pravidel soutěžního lezení ČHS.

=== Obtížnost
. Závody nejvyšších soutěží se uskuteční ve dvou dnech: 1. den chlapci kvalifikace (2 cesty) + dívky kvalifikace (2 cesty), které se lezou bez dodržení <<pravidla_sl.adoc#podminky-izolace,podmínek izolace>>, 2. den chlapci semifinále + finále, dívky semifinále + finále (vše za dodržení <<pravidla_sl.adoc#podminky-izolace,podmínek izolace>>) /. 
...
. Výši finanční a případně jiné podpory závodů všech typů podporovaných ČHS schvaluje KSL. V případě nedodržení Pravidel soutěžního lezení ČHS platných pro rok 2021 či ustanovení prováděcích předpisů na závodech ČPM bude dotace krácena.
