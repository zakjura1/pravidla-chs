...
=== Pro závody III. kategorie mají výše uvedené předpisy doporučující charakter. Pořadatelé mohou pravidla přizpůsobit svým možnostem a místním zvyklostem. Zcela závazné jsou pro pořadatele pouze body <<pioz-1>>, <<pioz-2>> a <<pioz-3>>. 
...
=== Nedílnou součástí těchto předpisů jsou <<../pravidla/pravidla_SL.adoc,Pravidla soutěžního lezení ČHS 2020>> 
