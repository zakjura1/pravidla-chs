...
. Pro cesty lezené stylem FLASH platí odstavce <<#registrace>>, <<#pristup-do-soutezniho-prostoru>>.<<#pdsp-3>> a <<#pristup-do-soutezniho-prostoru>>.<<#pdsp-4>> týkající se izolace ve stejném smyslu pro rozcvičovací prostory.
