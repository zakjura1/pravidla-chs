...
. Závody 2. ligy mají své vlastní hodnocení vedené na webových stránkách ČHS. Celkové pořadí je stanoveno po skončení posledního (finálového) závodu seriálu.
...
.. Rozhodčí ČHS
+
Rozhodčí ČHS je absolvent samostatného školení rozhodčích ČHS, které pořádá Český horolezecký svaz.
