...
[#bezpecnost-rychlost]
=== BEZPEČNOST
. Soutěžící může mít nasazené chrániče loktů nebo kolen aby se snížilo riziko zranění a krvácení.
...
. Každa cesta na rychlost bude vyčištěna po skončení oficiálního tréninku a před zahájením finálových rozběhů.
