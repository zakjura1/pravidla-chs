...
. Pokud jsou dostupné důkazy a materiály neprůkazné nebo nemůže-li se Odvolací porota jednohlasně shodnout na posouzení protestu, pak platí původní rozhodnutí. Protest v tomto případě bude označen  „*neurčitý*“ a neplatí se poplatek za protest.
...
. Je-li protest uznán nebo , protestné se vrací. Není-li protest uznán, protestné se nevrací.
