...
Výjimky ze soutěžních pravidel pro závody kategorií U14 jsou uvedeny v samostatném dokumentu „Výjimky ze soutěžních pravidel ČHS pro závody mládeže do 14 let v soutěžním lezení pro rok 2021“, který je přílohou Pravidel soutěžního lezení ČHS.
...
. Při závodech ČPM a ČP do 14 let v lezení na rychlost je počet postupujících dán Pravidly soutěžního lezení ČHS 2021 na základě počtu závodníků a zvoleného formátu, tedy klasického nebo světového.
...
. Nedílnou součástí těchto předpisů jsou <<pravidla_sl.adoc#,Pravidla soutěžního lezení ČHS 2021>> a <<vyjimky_z_pravidel_u14.adoc#,Výjimky ze soutěžních pravidel ČHS pro závody mládeže do 14 let v soutěžním lezení pro rok 2021>>.
