...
. [[pdsp-3,{counter:pdsp}]]Kouření v soutěžním prostoru je zakázáno. Pořadatel však může vyhradit prostor pro kuřáky tak, aby nedošlo k porušení podmínek izolace a nebyli omezování ostatní soutěžící.
