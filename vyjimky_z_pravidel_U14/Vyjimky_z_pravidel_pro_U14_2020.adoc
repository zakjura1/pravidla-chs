...
+
Geometrický průměr se používá také pro výpočet pořadí pro postup do finále na základě výsledků z kvalifikačních cest. Geometrický průměr je definován jako n-tá odmocnina ze součinu pořadí v jednotlivých cestách: asciimath:[Výsledné\ pořadí\ = root(n)(prod_(i=1)^n r_i)], kde asciimath:[r_1, … r_n] je umístění v jednotlivých kvalifikačních cestách, n je počet závodních cest.
