...
Pro závody Českého poháru do 14 let platí <<..\provadeci_predpisy_mladez\Provadeci_predpisy_mladez_2020.adoc,„Prováděcí předpisy ČHS pro závody mládeže v soutěžním lezení pro rok 2020“>> a <<../pravidla/pravidla_SL.adoc,„Pravidla soutěžního lezení ČHS 2020“>> s výjimkami v těchto bodech:
...
+
Geometrický průměr se používá také pro výpočet pořadí pro postup do finále na základě výsledků z kvalifikačních cest. Geometrický průměr je definován jako n-tá odmocnina ze součinu pořadí v jednotlivých cestách: asciimath:[VP = root(n)(prod_(i=1)^n r_i)], kde asciimath:[VP] je výsledné pořadí a asciimath:[r_1, …, r_n] je umístění v jednotlivých kvalifikačních cestách, n je počet závodních cest.
...
Pro závody mládeže do 14 let neplatí ustanovení <<../pravidla/pravidla_SL.adoc#pl-kv-flash-bouldering-5,5.4.5>> a <<../pravidla/pravidla_SL.adoc#pl-kv-flash-bouldering-7,5.4.7>> Pravidel soutěžního lezení 2020, která zde mají pouze doporučující charakter.
