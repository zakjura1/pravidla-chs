...
. Závody nejvyšších soutěží se uskuteční ve dvou dnech: 1. den muži kvalifikace (2 cesty) + ženy kvalifikace (2 cesty), které se lezou stylem flash, 2. den muži semifinále + finále, ženy semifinále + finále (vše stylem OS) /. 

. Boulderingové závody nejvyšších soutěží se uskuteční ve dvou dnech. Kvalifikace se mohou lézt stylem flash nebo OS, finále se lezou stylem OS. Pořadatel si může sám zvolit formát finále – tj. buď závodníci lezou zároveň na všech boulderech nebo všichni lezou postupně stejný boulder – formát SP (mohou lézt ženy i muži zároveň). V případě formátu SP musí být zařazeno semifinále. Doporučený formát je SP.

. Závody na obtížnost 1. ligy se uskuteční na dvou kvalifikačních cestách stylem flash a finále OS v jednom dni.

. Závody v boulderingu 1. ligy mohou mít kvalifikace flash nebo OS, finále musí být stylem OS, přičemž ve finále platí stejné možnosti jako u závodů nejvyšších soutěží. 
