...
:toc: left
:toclevels: 2
= Výjimky ze soutěžních pravidel ČHS pro Nejvyšší soutěže a 1. ligu mládeže do 14 let v soutěžním lezení pro rok 2021
...
== Obecně
Pro Mistrovství republiky a závody 1. ligy v kategoriích do 14 let platí <<provadeci_predpisy_mladez_1_liga.adoc#,„Prováděcí předpisy ČHS pro závody nejvyšších soutěží a 1. ligy mládeže v soutěžním lezení pro rok 2021“>> a <<pravidla_sl.adoc#,„Pravidla soutěžního lezení ČHS 2021“>> s výjimkami v těchto bodech:
...
U závodů nejvyšší kategorie a 1. ligy v kategoriích do 14 let, lze kromě ustanovení pravidel soutěžního lezení využít i tyto možnosti:
...
== Bouldering
=== Povolené formáty
U závodů 1. ligy, kde lze kromě ustanovení pravidel soutěžního lezení využít i tyto možnosti:
...
. Pro závody mládeže v kategoriích do 14 let neplatí ustanovení <<pravidla_sl.adoc#pl-kv-flash-bouldering-5,5.4.5>> a <<pravidla_sl.adoc#pl-kv-flash-bouldering-7,5.4.7>> <<pravidla_sl.adoc#,Pravidel soutěžního lezení 2021>>, která zde mají pouze doporučující charakter.
