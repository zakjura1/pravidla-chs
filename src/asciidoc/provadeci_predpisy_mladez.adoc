...
|===
+
. Dosáhnou-li závodníci shodného výsledku, bude jim přidělen podíl součtu příslušných bodů. Příklad: tři závodníci připadají na 7. -9. místo; asciimath:[(11 + 9 + 8) -: 3 = 9,3] bodů.
