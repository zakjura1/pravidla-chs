...
. Všechny soutěže v lezení na obtížnost se lezou se spodním jištěním soutěžícího. U vybraných kategorií mládeže je povoleno lézt s horním jištěním – top-rope. Příslušné kategorie jsou uvedeny ve <<vyjimky_z_pravidel_pro_U14.adoc#bezpecnost-a-jisteni,výjimkách z pravidel pro závody mládeže U14>>.
...
Pro kvalifikační kola platí odstavce <<#registrace>>, <<#pristup-do-soutezniho-prostoru>>.<<#pdsp-2>> a <<#pristup-do-soutezniho-prostoru>>.<<#pdsp-3>>.
...
[#prubeh-souteze]
=== PRŮBĚH SOUTĚŽE
. Semifinálové a finálová kola v lezení na obtížnost se musí konat za <<#podminky-izolace,podmínek izolace>>. Soutěžící, kteří v těchto kolech startují se musí ohlásit v izolační zóně během kontroly docházky po oficiálním uzavření izolace. Soutěžící, kteří tak neučiní, nemohou v daném kole soutěžit.
...
.. pokud video předlezení není možné, pak pomocí živého předlezení, které musí začít nejpozději 15 minut před pokusem prvního závodníka
...
. [[pl-1,{counter:pl}]]Stanovená délka doby lezení je 6 minut ve všech kolech.
. [[pl-2,{counter:pl}]]V momentě, kdy soutěžící vejde do soutěžní zóny u paty lezecké cesty, má 40 vteřin na to, aby nastoupil do cesty. Těchto 40 vteřin konečné prohlídky cesty není součástí celkového času vyhrazeného na přelezení cesty. Nezačne-li soutěžící po vypršení těchto 40 vteřin lézt, musí být ke startu okamžitě vyzván. Jakákoliv další prodleva bude mít za následek disciplinární postih v souladu s částí <<#disciplinarni-rizeni>>. 40 vteřin prohlídky cesty platí i v případě lezení kol, pro které neplatí podmínky izolace.
. [[pl-3,{counter:pl}]]Každý pokus soutěžícího je považovaný za zahájený a čas se začne měřit v momentě, kdy obě chodidla soutěžícího opustí zem. Aby se předešlo pochybnostem, traťový rozhodčí určí, zda pokus začal nebo se jedná o úpravu postavení před startem.
...
. [[pl-5,{counter:pl}]]V průběhu pokusu na cestě:
.. Soutěžící musí být stále v <<#legitimni-pozice,legitimní pozici>>. To je z hlediska postupového jištění když:
...
.. Nepodaří se mu zapnout expresku podle pravidel v souladu s odstavcem <<#prubeh-lezeni>>.<<#pl-5>>;
